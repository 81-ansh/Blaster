...
#include "../../../../../../../../../TUF/Software/UE_5.7/Engine/Plugins/Media/BlackmagicMedia/Source/ThirdParty/Build/Include/DeckLinkAPI_h.h"
...
void ABlasterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* Input = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		Input->BindAction(GrenadeThrowAction, ETriggerEvent::Started, this, &ABlasterCharacter::GrenadeButtonPressed);
	}
}
...
void ABlasterCharacter::CancelReloadMontage()
{
	if (Combat == nullptr || Combat->EquippedWeapon == nullptr) return;
