...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// Calculate body shot damage by multiplying times hit times damage - store in DamageMap
		...
		// Calculate headshot damage by multiplying times hit times headshot damage - store in DamageMap
